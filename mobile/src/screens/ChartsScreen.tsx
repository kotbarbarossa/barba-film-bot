      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 8 }}>
        {CHART_IDS.map((c, i) => (
          ...
          >
            ...
            <Text style={{ fontFamily: 'Neucha', fontSize: 22, lineHeight: 26, paddingVertical: 4, letterSpacing: 6, color: i === 0 ? theme.onYellow : theme.inkFaint, opacity: i === 0 ? 0.4 : 1 }}>›</Text>
          </Pressable>
        ))}
      </ScrollView>
    </Phone>
